...
\begin{remark} This connection between simplicial sets and spaces emerged initially in a research program which used to be called ``combinatorial homotopy theory,'' led by Kan in the 1950's. % Goerss--Jardine p2
\end{remark}
