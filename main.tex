...
\end{align*}
is a group completion.\footnote{Interesting, this seems to be special to $\P^1$. Such a statement is never true for punctured affine space, for example \cite{BrazeltonHornslien}.}
\end{theorem}
